...
PI__ const s_productionInfo[] = 
{
     ...
     {298, 4}, // 7: szekcio (SECTION) ->  SECTION TEXT global utasitasok
     {299, 2}, // 8: global (GLOBAL) ->  GLOBAL AZONOSITO
     {300, 2}, // 9: datadeklaraciok ->  datadecl datadeklaraciok
     {300, 1}, // 10: datadeklaraciok ->  datadecl
     {301, 2}, // 11: bssdeklaraciok ->  bssdecl bssdeklaraciok
     {301, 1}, // 12: bssdeklaraciok ->  bssdecl
     {303, 4}, // 13: datadecl (AZONOSITO) ->  AZONOSITO KETTOSPONT meretdata szamok
     {305, 3}, // 14: szamok (VESSZO) ->  szamok VESSZO SZAM
     {305, 1}, // 15: szamok (SZAM) ->  SZAM
     {304, 4}, // 16: bssdecl (AZONOSITO) ->  AZONOSITO KETTOSPONT meretbss SZAM
     {306, 1}, // 17: meretdata (DB) ->  DB
     {306, 1}, // 18: meretdata (DW) ->  DW
     {306, 1}, // 19: meretdata (DD) ->  DD
     {307, 1}, // 20: meretbss (RESB) ->  RESB
     {307, 1}, // 21: meretbss (RESW) ->  RESW
     {307, 1}, // 22: meretbss (RESD) ->  RESD
     {302, 2}, // 23: utasitasok ->  utasitas utasitasok
     {302, 1}, // 24: utasitasok ->  utasitas
     {308, 4}, // 25: utasitas (KETARGUMENTUMOS) ->  KETARGUMENTUMOS argumentum VESSZO argumentum
     {308, 2}, // 26: utasitas (EGYARGUMENTUMOS) ->  EGYARGUMENTUMOS argumentum
     {308, 2}, // 27: utasitas (UGROUTAS) ->  UGROUTAS AZONOSITO
     {308, 3}, // 28: utasitas (UGROUTAS) ->  UGROUTAS NEAR AZONOSITO
     {308, 1}, // 29: utasitas (RET) ->  RET
     {308, 2}, // 30: utasitas ->  cimke utasitas
     {309, 2}, // 31: cimke (AZONOSITO) ->  AZONOSITO KETTOSPONT
     {310, 1}, // 32: argumentum ->  kifejezes
     {310, 2}, // 33: argumentum (BYTE) ->  BYTE kifejezes
     {310, 2}, // 34: argumentum (WORD) ->  WORD kifejezes
     {310, 2}, // 35: argumentum (DWORD) ->  DWORD kifejezes
     {310, 3}, // 36: argumentum (NYITOSZOGZAROJEL) ->  NYITOSZOGZAROJEL kifejezes CSUKOSZOGZAROJEL
     {310, 4}, // 37: argumentum (BYTE) ->  BYTE NYITOSZOGZAROJEL kifejezes CSUKOSZOGZAROJEL
     {310, 4}, // 38: argumentum (WORD) ->  WORD NYITOSZOGZAROJEL kifejezes CSUKOSZOGZAROJEL
     {310, 4}, // 39: argumentum (DWORD) ->  DWORD NYITOSZOGZAROJEL kifejezes CSUKOSZOGZAROJEL
     {311, 3}, // 40: kifejezes (NYITOZAROJEL) ->  NYITOZAROJEL kifejezes CSUKOZAROJEL
     {311, 3}, // 41: kifejezes (MULTIPLY) ->  kifejezes MULTIPLY kifejezes
     {311, 3}, // 42: kifejezes (DIVIDE) ->  kifejezes DIVIDE kifejezes
     {311, 3}, // 43: kifejezes (PLUS) ->  kifejezes PLUS kifejezes
     {311, 3}, // 44: kifejezes (MINUS) ->  kifejezes MINUS kifejezes
     {311, 1}, // 45: kifejezes (REGISZTER) ->  REGISZTER
     {311, 1}, // 46: kifejezes (AZONOSITO) ->  AZONOSITO
     {311, 1}, // 47: kifejezes (SZAM) ->  SZAM
     {312, 1}, // 48: start_$ ->  start
};
...
#line 88 "elsoparse.y"
        ...
        case 13:
#line 119 "elsoparse.y"
        {
         int meret = (*d_vsp__[-1].szam);
         int pluszhossz = meret * d_vsp__[0].intvec->size();

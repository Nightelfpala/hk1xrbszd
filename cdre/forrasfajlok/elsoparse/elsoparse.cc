// Generated by Bisonc++ V4.09.02 on Tue, 17 May 2016 01:20:09 +0200
...
#line 121 "elsoparse.y"
        {
         if ( valtozo_kezdetek.count(*d_vsp__[-3].szoveg) > 0 )
         {
         std::stringstream ss;
         ss << d_loc__.first_line << ". sor: " << "ujradefinialt valtozo" << std::endl
         << "\t" << (std::string("") + *d_vsp__[-3].szoveg) << std::endl;
         errorMsg = ss.str();
